import { ReactComponent as IconBackend } from './icons/icon-backend.svg';
...
export { IconBackend, IconCalendar, IconCart, IconClock, IconDesign, IconFrontend, IconMarketing };
